                ...
                <div className="mx-auto max-w-7xl lg:max-w-7xl">
                    <div className="flex justify-center sm:justify-start px-3">
                        ...
                        <Link onClick={() => window.scrollTo(0, 0)}
                            className="text-md ml-auto mt- hidden sm:inline font-semibold tracking-normal text-gray-700 sm:text-1.5xl inter hover:underline underline-offset-4 decoration-amber-500 decoration-2"
                    ...
                    {/* Mobile button */}
                    <div onClick={() => window.scrollTo(0, 0)} className="text-center py-6 sm:hidden">
            ...
            <div className="bg-white px-3 md:px-4">
                <div className="mx-auto max-w-7xl py-2 sm:py-12 lg:max-w-7xl">
                    <div className="flex justify-center sm:justify-start px-3">
                        ...
                        <Link onClick={() => window.scrollTo(0, 0)} className="text-md ml-auto mt-2 hidden sm:inline font-semibold tracking-normal text-gray-700 sm:text-1.5xl inter hover:underline underline-offset-4 decoration-amber-500 decoration-2"
